...
#include "mumassMuonium2S.hh" //included by Gianluca
#include "mumassLaserExcitation.hh" //included by Gianluca

#include "MuDecayChannel.hh"
#include "Mu2SDecayChannel.hh"
#include "MuDecayChannelWithSpin.hh"	
#include "mumassMu2SRelaxation.hh" //included by Gianluca
//
...
void musrPhysicsList::ConstructLeptons()
{
  ...
  // Muonium 2S
  mumassMuonium2S::Muonium2SDefinition(); //included by Gianluca
  //
  // nu_e
  ...
  G4DecayTable* Muonium2SDecayTable = new G4DecayTable();
  Muonium2SDecayTable -> Insert(new Mu2SDecayChannel("Mu2S",1));
  mumassMuonium2S::Muonium2SDefinition()->SetDecayTable(Muonium2SDecayTable);
...
//	  else if (stringProcessName=="G4DecayWithSpin")      pManager->AddProcess(new G4DecayWithSpin,nr1,nr2,nr3);
	...
	//  else if (stringProcessName=="G4hLowEnergyIonisation")      pManager->AddProcess(new G4hLowEnergyIonisation,nr1,nr2,nr3);
	  ...
	  else if (stringProcessName=="mumassMuFormation")              pManager->AddProcess(new mumassMuFormation,nr1,nr2,nr3); //included by Gianluca
	  else if (stringProcessName=="mumassLaserExcitation")              pManager->AddProcess(new mumassLaserExcitation,nr1,nr2,nr3); //included by Gianluca
	  else if (stringProcessName=="mumassMu2SRelaxation")              pManager->AddProcess(new mumassMu2SRelaxation,nr1,nr2,nr3); //included by Gianluca
