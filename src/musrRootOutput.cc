...
musrRootOutput::musrRootOutput() {
  ...
  ProcessIDMapping["MuFormation_Silcia"] = 20;
  ProcessIDMapping["Mu2SRelaxation"] = 21;
...
void musrRootOutput::BeginOfRunAction() {
  ...
  if (boolIsAnySpecialSaveVolumeDefined) {
    ...
    rootTree->Branch("save_edep",&save_edep,"save_edep[save_n]/D");
...
void musrRootOutput::SetSaveDetectorInfo (G4int ID, G4int particleID, G4double ke, G4double edep,
  ...
  if (save_n>=save_nMax) {
    ...
    save_edep[save_n]=edep/CLHEP::MeV;
