...
// ------------------------------------------------------------
#ifndef Mu2SDecayChannel_h
#define Mu2SDecayChannel_h 1
...
class Mu2SDecayChannel :public G4VDecayChannel
{
  // Class Decription
  ...
  public:  // With Description
    //Constructors 
      Mu2SDecayChannel(const G4String& theParentName,
			   G4double  theBR);
    //  Destructor
      virtual ~Mu2SDecayChannel();
